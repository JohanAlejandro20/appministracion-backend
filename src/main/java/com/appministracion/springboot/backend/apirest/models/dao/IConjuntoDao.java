...
public interface IConjuntoDao extends CrudRepository<Conjunto, Long> {
    ...
    @Query(value = "select u.nombre as nombreUsuario,c.nombre as nombreConjunto from usuarios u inner join conjuntos c on u.cod_conjunto = c.cod_conjunto where u.cod_usuario = :cod_usuario", nativeQuery = true )   
